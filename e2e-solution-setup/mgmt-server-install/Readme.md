...
* Set values of environment variables : copy the file .env-template.sh to .env. Then set the values of the variables in the .env file. These variables are:
  ...
  * GITHUB_APP_REPOSITORY: Add value like https://github.com/cse-labs/platformops-ephemeral-test-env <!-- # Change to your App Repo  -->
  * GITHUB_INFRA_REPOSITORY: Add value like https://github.com/cse-labs/platformops-ephemeral-test-env.git <!-- # Change to your Infra Repo  -->
